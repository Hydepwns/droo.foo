...
export declare function parseReactComponentSourceInputs(sys: DevToolsSys, srcCmp: ReactComponentSource): Promise<import("../../../types").ComponentInput[]>;
...
export declare function getReactComponentsFromSourceFile(sys: DevToolsSys, filePath: string, sourceFile: ts.SourceFile): Promise<ReactComponentSource[]>;
export interface ReactComponentSourceNode {
    fnName: string;
    fnParams: ts.NodeArray<ts.ParameterDeclaration>;
}
